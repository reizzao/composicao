	...
	Estrofes: EstrofesDefault{
		...
		Estrofe_A: Estrofe_Props{
			...
			Versos: []Verso{
				...
				{Props: Verso_Props{
					Numero: 3, RazaoDoVerso: NAVIDA_SACADA_POESIA_EMPROL_DETODOS,
		...
		Estrofe_Refrao: Estrofe_Props{
			...
			Versos: []Verso{
				{Props: Verso_Props{
					Numero: 1, RazaoDoVerso: NAVIDA_SACADA_POESIA_EMPROL_DETODOS,
					TempoVerbal: TEMPO_FUTURO, PersonagemTema: PERSON_EU}},
				{Props: Verso_Props{
					Numero: 2, RazaoDoVerso: COMO_ASSIM_EAI,
					TempoVerbal: TEMPO_PRESENTE, PersonagemTema: PERSON_AOUTRA}},
				{Props: Verso_Props{
					Numero: 3, RazaoDoVerso: NAVIDA_SACADA_POESIA_EMPROL_DETODOS,
					TempoVerbal: TEMPO_FUTURO, PersonagemTema: PERSON_TODOSNOS}},
			}}, // Estrofe_
